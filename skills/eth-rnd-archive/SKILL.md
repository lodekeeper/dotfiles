...
- Direct mentions of Lodestar or ChainSafe, including a bare role ping: `<@&595681771690000403>` is the Lodestar team role (resolved 2026-09-25 by usage, 36 archive messages, e.g. barnabasbusa 2025-09-10 "lodestar<@&595681771690000403> nodes"; an inference, not a Discord lookup). Put it in the keyword regex next to the names and Nico's ID 586161934425128960: a bare "cc <@&595681771690000403>" (tbenr 2025-10-31, parithosh 2026-01-30) contains no other keyword.
